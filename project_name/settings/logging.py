...
LOGGING["formatters"].update(
    {
        ...
        "verbose": {"format": "%(levelname)s %(asctime)s - %(pathname)s - L %(lineno)d\n\t%(message)s"},
    }
)
...
LOGGING["handlers"]["management"] = {"class": "logging.StreamHandler", "formatter": "management", "level": "DEBUG"}
LOGGING["loggers"]["management"] = {"handlers": ["management"], "level": "WARNING"}
